...
test_total_dose_calc_outcomes = [[3.66, 0, 4],
                                 [0.05, 1.32, 1],
                                 ]
...
class TestInsulinCalc:
    ...
    @pytest.mark.parametrize('bolus_dose, correction_dose, total_insulin_dose', test_total_dose_calc_outcomes)
    def test_calculate_total_dose(self, bolus_dose, correction_dose, total_insulin_dose):
        self.calc.bolus = bolus_dose
        self.calc.correction_dose = correction_dose
